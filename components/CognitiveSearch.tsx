            ...
            <div className="space-y-12">
              <div className="flex items-center justify-between">
                ...
                <button 
                   ...
                   className="px-6 py-2 border-2 border-slate-100 text-[10px] font-black text-slate-400 uppercase tracking-widest rounded-xl hover:bg-rose-50 hover:text-rose-500 hover:border-rose-100 transition-all flex items-center gap-2"
                >
